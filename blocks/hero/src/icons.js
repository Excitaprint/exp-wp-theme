export const GoogleGIcon = (props) => (
  ...
  >
    <defs>
      <linearGradient id="a_g_hero">
        <stop offset="0" stopColor="#0fbc5c" />
        <stop offset="1" stopColor="#0cba65" />
      </linearGradient>
      <linearGradient id="g_g_hero">
      ...
      <linearGradient id="d_g_hero">
        <stop offset=".4084578" stopColor="#fb4e5a" />
        <stop offset="1" stopColor="#ff4540" />
      </linearGradient>
      <linearGradient id="c_g_hero">
      ...
      <clipPath clipPathUnits="userSpaceOnUse" id="i_g_hero">
        <path
